	...
	<div align="center">
		...
		<form action="" method="post">
			...
			<tr><td colspan="22" align="center">
				<button type="submit" class="btn btn-outline-success">Update Details</button></td>
			</tr>
		</table>
		</form>
		<hr>
...
$query="UPDATE `employee` SET `Fname`='$fn',`Lname`='$ln',`Mobile`='$mob',`Department`='$dp',`Salary`=$sal WHERE ID=$id";
